...
<script type="text/javascript">
  ...
  <body>
    <div id="smWrap">
      ...
      보낸이 : &nbsp;<input type="text" readonly value="${sendNotes.sendnote == true ? sendNotes.sendUserId : rcvNotes.sendUserId }" class="receiveUserId" name="sendUserId">
      ...
      <input class="submit_btn" onclick="window.open('/Note/resendMsg', '_blank', 'width=600, height=600')" type="button" value="답장">
