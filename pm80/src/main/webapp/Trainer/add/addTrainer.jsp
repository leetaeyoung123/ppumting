	...
	<div id="wrap">
		...
		<div id="login_wrap">
			<form class="login_form" action="addTrainer" method="post">
				...
				<div class="id_input">
					<input type="text" name="trainerId" maxlength="13"
						placeholder="아이디">
				</div>


				<div class="pw_input">
					<input type="password" name="passwd" maxlength="13"
						placeholder="비밀번호">
				</div>
				...
				<div class="addr_input">
					<select name="addr1">
						...
						<option>전라 북도</option>
						<option>전라 남도</option>
					</select> <input class="addr_input_1" type="text" name="addr2"
						placeholder="상세 주소를 적어주세요"><br>
				</div>
				<div class="price"></div>
				<input class="prevbtn" type="button" value="뒤로가기"
					onclick="history.back(-1);"
					style="width: 120px; height: 60px; border: 5px solid #0078AA; background: #0078AA; color: #F6F6F6; border-radius: 25px; padding-left:10px; cursor: pointer;">
